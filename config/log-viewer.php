...
return [
    ...
    */
    ...
    // 'auth' is added because the package ships without it: out of the box
    // /log-viewer answers 200 to an anonymous visitor outside production.
    // The viewLogViewer gate in AppServiceProvider then narrows it to the
    ...
    */
    ...
    // The API is what actually serves log contents, so it needs the same
    // guard as the page. Leaving it open would make the page gate cosmetic.
    'api_middleware' => [
